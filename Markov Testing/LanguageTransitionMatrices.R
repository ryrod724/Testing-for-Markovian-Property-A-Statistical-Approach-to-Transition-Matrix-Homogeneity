...
#####################################################
library(tidyverse)
text <- read_file("ATaleOfTwoCities.txt")
...
############################################################
library(tidyverse)
text <- read_file("CienAnosDeSoledad.txt")
...
#########################################################
library(tidyverse)
text <- read_file("LePetitPrince.txt")
